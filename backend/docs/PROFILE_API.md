...
- **생년월일 검증** — BMA-19 안건3 확정(2026-08-18): 미성년자 판정은 S15 본인인증
  (BMA-79)이 돌려주는 인증사 생년월일로만 한다. S3 에서 자기 입력한 생년월일은
  참고용이라 법적 기준이 아니며, 여기서는 "과거 날짜"만 본다. 성인 검증을
  이 API 에 넣지 않는 것은 누락이 아니라 의도된 설계다.
